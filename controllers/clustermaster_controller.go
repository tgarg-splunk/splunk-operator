...
func (r *ClusterMasterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &enterprisev4.ClusterMaster{}
	...
	if annotations != nil {
		if _, ok := annotations[enterprisev4.ClusterMasterPausedAnnotation]; ok {
...
func (r *ClusterMasterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&enterprisev4.ClusterMaster{}).
		...
		Watches(&source.Kind{Type: &appsv1.StatefulSet{}},
			&handler.EnqueueRequestForOwner{
				IsController: true,
				OwnerType:    &enterprisev4.ClusterMaster{},
			}).
