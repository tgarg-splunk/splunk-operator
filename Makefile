...
test: manifests generate fmt vet envtest ## Run tests.
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) -p path)" go test  -coverprofile cover.out  ./controllers/... pkg/splunk/common pkg/splunk/enterprise pkg/splunk/controller pkg/splunk/client pkg/splunk/util
