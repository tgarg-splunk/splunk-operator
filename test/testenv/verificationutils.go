...
// VerifyMCReady verify Standlone is in ReadyStatus and does not flip-flop
func VerifyMCReady(deployment *Deployment, deploymentName string, monitoringConsole *enterprisev1.MonitoringConsole, testenvInstance *TestEnv) {
